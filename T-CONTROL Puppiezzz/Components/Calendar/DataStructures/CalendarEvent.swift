...
public struct CalendarEvent<T:Hashable> {
    ...
    public init(calendar:Calendar = Calendar.current, dateString:String, dateFormat:String = "MM/dd/yyyy", data:T, symbol: String, bgColor: Color) {
        self.calendar = calendar
        self.data = data
        self.symbol = symbol
        self.bgColor = bgColor
